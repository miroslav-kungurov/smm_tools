...
import pandas as pd
import json
from get_data_from_tg_date import process_channels
...
def add_metrics_to_excel(input_excel, input_json, output_excel):
    ...
    df.columns = ['Column1', 'Channel Link', 'Start date (inclusive)', 'End date (inclusive)', 'Post Count', 'Subscribers', 'Total Views', 'Average Reach', 'Median', 'Engagement Rate']
